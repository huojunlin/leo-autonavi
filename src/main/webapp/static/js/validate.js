...
(function($) {
	...
	$.message = function() {
		...
		$message.children("div").removeClass("messagewarnIcon messageerrorIcon messagesuccessIcon messageloadingIcon").addClass("message" + message.type + "Icon").html(message.content);
	...
	$.dialog = function(options) {
		...
		$dialog.css({"width": settings.width, "height": settings.height, "margin-left": - parseInt(settings.mleft / 2), "z-index": zIndex ++});
		dialogShow();
